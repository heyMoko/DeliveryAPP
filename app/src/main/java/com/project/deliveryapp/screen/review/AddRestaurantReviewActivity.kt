package com.project.deliveryapp.screen.review
...
import com.project.deliveryapp.databinding.ActivityAddRestaurantReviewBinding
import com.project.deliveryapp.screen.review.gallery.GalleryActivity
import com.project.deliveryapp.screen.review.photo.CameraActivity
import com.project.deliveryapp.widget.adapter.PhotoListAdapter
...
class AddRestaurantReviewActivity : AppCompatActivity() {
    ...
    private fun uploadArticle(userId: String, title: String, content: String, rating: Float, imageUrlList: List<String>) {
        ...
        hideProgress()
        Toast.makeText(this, "리뷰가 성공적으로 등록 되었습니다.", Toast.LENGTH_SHORT).show()
